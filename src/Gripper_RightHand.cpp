/**
* \file Gripper_RightHand.cpp
* \brief TIAGo's right hand's gripper controller
...
* Subscribes to: <BR>
*
* /right_hand_grip : to have info about user's right hand's gestures from Unity
*
*
* Action Client to: <BR>
*
* /parallel_gripper_right_controller/follow_joint_trajectory : to move TIAGo's right gripper
*
*
* Service client to: <BR>
*
* /parallel_gripper_right_controller/grasp : to perform grasping action with TIAGo's gripper
*
*
* Description:
*
* This simple node subscribes to the /right_hand_grip to receive data from Unity's publisher about the gestures of the user's right hand. Then uses the received information to close TIAGo's gripper calling /parallel_gripper_right_controller/grasp service, or to open it calling /parallel_gripper_right_controller/follow_joint_trajectory action service.
**/
...
* \return void
*
* This function is called to creat a client to the /parallel_gripper_right_controller/follow_joint_trajectory action service, used to control TIAGo's right gripper
*
**/
/* ***************************************************************************/
...
* \return void
*
* This function opens TIAGo's gripper, firstly by calling 'waypoints_openGripper_goal' function to generate the trajectory, the sending the result to the action client '/parallel_gripper_right_controller/follow_joint_trajectory'
*
**/
/* ***************************************************************************/
...
// 
/**
* \brief Subscriber Callback for /right_hand_grip
* 
...
*
*
* Entry point. Initializes the node, the subscriber to /right_hand_grip_topic, the action client to open TIAGO's gripper and the service client to /parallel_gripper_right_controller/grasp to close it. Then in the main loop, it waits for a new gesture to be received, then sends a request to the correspondant service/action to open or close TIAGo's gripper.
*
**/
